...
class STM_Metaboxes
{
    ...
    {
		if(!empty($_GET['page']) && $_GET['page'] === 'dokan'){
			return false;
		}
        $v = time();
        ...
        wp_enqueue_media();
        wp_enqueue_script('vue2.js', $base . 'js/vue.min.js', array('jquery'), $v);
        wp_enqueue_script('vue-resource.js', $base . 'js/vue-resource.min.js', array('vue2.js'), $v);
        wp_enqueue_script('vue2-datepicker.js', $base . 'js/vue2-datepicker.min.js', array('vue2.js'), $v);
        wp_enqueue_script('vue-select.js', $base . 'js/vue-select.js', array('vue2.js'), $v);
        wp_enqueue_script('vue2-editor.js', $base . 'js/vue2-editor.min.js', array('vue2.js'), $v);
        wp_enqueue_script('vue2-color.js', $base . 'js/vue-color.min.js', array('vue2.js'), $v);
        wp_enqueue_script('sortable.js', $base . 'js/sortable.min.js', array('vue2.js'), $v);
        wp_enqueue_script('vue-draggable.js', $base . 'js/vue-draggable.min.js', array('sortable.js'), $v);
        wp_enqueue_script('wpcfto_mixins.js', $base . 'js/mixins.js', array('vue2.js'), $v);
        wp_enqueue_script('wpcfto_metaboxes.js', $base . 'js/metaboxes.js', array('vue2.js'), $v);

!(function ($) {
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction( 'frontend/element_ready/styler-animated-headline.default', ntrAnimatedHeadline );
        elementorFrontend.hooks.addAction('frontend/element_ready/styler-onepage.default', ntrAnimatedHeadline);
    });

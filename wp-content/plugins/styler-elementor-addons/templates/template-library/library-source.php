...
* Library api class
*
* @package StylerAddons
* @author StylerMonster
*/
...
class Library_Source extends Source_Base {
    ...
    */
    const LIBRARY_CACHE_KEY = 'styler_library_cache';
    ...
    */
    const API_TEMPLATES_INFO_URL = 'https://elementories.com/styler/wp-content/template-library/info.json';

    /**
    * Template data api url
    */
    const API_TEMPLATE_DATA_URL = 'https://elementories.com/styler/wp-content/template-library/templates/';

    public function get_id() {
        return 'styler-library';
    }

    public function get_title() {
        return __( 'Styler Library', 'styler' );
    }
    ...
    */
    ...
    public static function request_template_data( $template_id ) {
        ...
        $body = [
            ...
            'version' => STYLER_PLUGIN_VERSION,
        ];
        /*
        if ( styler_has_pro() ) {
            $body['has_pro'] = 1;
            $body['pro_version'] = STYLER_PLUGIN_VERSION;
        }
        */
        $response = wp_remote_get(
            self::API_TEMPLATE_DATA_URL.$template_id.'.json',
            [
                'body' => $body,
                'timeout' => 25
            ]
    ...
    */
    public function get_data( array $args, $context = 'display' ) {
        ...
        if ( empty( $data ) || empty( $data['content'] ) ) {
            throw new \Exception( __( 'Template does not have any content', 'styler' ) );
        }

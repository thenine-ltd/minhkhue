...
class Styler_WC_Product_Add_To_Cart extends Widget_Base {

    public function get_name() {
        return 'styler-wc-product-add-to-cart';
    }
    public function get_title() {
        return __( 'Add To Cart', 'styler' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'button_bg_color',
            [
                'label' => __( 'Background Color', 'styler' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_transition',
            [
                'label' => __( 'Transition Duration', 'styler' ),
    ...
    protected function render() {
        ...
        <div class="styler-add-to-cart styler-product-<?php echo esc_attr( $product->get_type() ); ?>">

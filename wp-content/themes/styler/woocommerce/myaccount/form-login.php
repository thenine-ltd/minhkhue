...
if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) {
    if ( 'multisteps' == apply_filters('styler_myaccount_page_type',styler_settings( 'myaccount_page_type', 'multisteps' ) ) ) {
        ...
        ?>
        <div class="styler-default-type row" id="customer_login">

            <div class="col-12 col-lg-6">

                <h3><?php esc_html_e( 'Login', 'styler' ); ?></h3>

                <form class="woocommerce-form woocommerce-form-login login row<?php echo esc_attr( $styler_ajax_attr ); ?>" method="post">
                    ...
                    <p class="woocommerce-form-row form-row col-12">
                        ...
                        <button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="<?php esc_attr_e( 'Log in', 'styler' ); ?>"><?php esc_html_e( 'Log in', 'styler' ); ?></button>
                    </p>
            ...
            <?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <h3><?php esc_html_e( 'Register', 'styler' ); ?></h3>
                    ...
                    <form method="post" class="woocommerce-form woocommerce-form-register register row" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
                        ...
                        <?php else : ?>
                            ...
                            <p class="woocommerce-form-row form-row col-12"><?php esc_html_e( 'A password will be sent to your email address.', 'styler' ); ?></p>
